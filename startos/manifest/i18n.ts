export const short = {
  en_US: 'A CI/CD runner for Gitea Actions',
  es_ES: 'Un ejecutor CI/CD para Gitea Actions',
  de_DE: 'Ein CI/CD-Runner für Gitea Actions',
  pl_PL: 'Runner CI/CD dla Gitea Actions',
  fr_FR: 'Un exécuteur CI/CD pour Gitea Actions',
}
